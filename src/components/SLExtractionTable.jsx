...
const initialData = [
  {
    ...
    slType: 'SL',
    slCategory: 'Availability',
    slSubcategory: 'Response Time',
    priority: 'High',
    unitOfMeasurement: 'Minutes',
    minOrMax: 'Maximum',
    expectedTargetValue: '60',
    thresholdValueFloor: '90',
    thresholdValueBasement: '120',
    ...
    slCreditClauseDescription: 'Credits after 3 defaults in a month',
    ...
    earnbackApplicable: 'No',
    earnbackClauseDescription: 'N/A',
    earnbackMode: 'N/A',
    earnbackFrequency: 'N/A',
    serviceLevelDefault: 'Exceeded max response time',
    persistentDefaultClause: '3 consecutive months triggers governance review',
    terminationTrigger: 'Same SL missed 3 consecutive months',
  ...
  },
  {
    ...
    minOrMax: 'Maximum',
    expectedTargetValue: '4',
    thresholdValueFloor: '6',
    thresholdValueBasement: '8',
    measurementWindow: 'Per incident',
    computationFrequency: 'Monthly',
    exclusions: 'Planned maintenance and force majeure',
    slCreditApplicable: 'Yes',
    slCreditClauseDescription: 'Credits after 4 defaults in a month',
    slCreditMode: 'Percent of monthly charges',
    slCreditFormula: '3% of monthly charge per default beyond threshold',
    slCreditFrequency: 'Monthly',
    earnbackApplicable: 'No',
    earnbackClauseDescription: 'N/A',
    earnbackMode: 'N/A',
    earnbackFrequency: 'N/A',
    serviceLevelDefault: 'Exceeded max response time',
    persistentDefaultClause: '4 defaults in rolling 3 months triggers action',
    terminationTrigger: 'Same SL missed 4 months in 12',
    slStartDate: '2024-01-01',
    slEndDates: '2025-12-31',
    slEffectiveDate: '2024-02-01',
    reportingFrequency: 'Monthly',
  ...
  },
  {
    ...
    slType: 'SL',
    slCategory: 'Resolution',
    slSubcategory: 'Time to Resolve',
    priority: 'High',
    unitOfMeasurement: 'Hours',
    minOrMax: 'Maximum',
    expectedTargetValue: '24',
    thresholdValueFloor: '36',
    thresholdValueBasement: '48',
    measurementWindow: 'Per incident',
    computationFrequency: 'Monthly',
    exclusions: 'Customer-caused delays excluded',
    slCreditApplicable: 'Yes',
    slCreditClauseDescription: 'Credits after 2 defaults in a month',
    slCreditMode: 'Percent of monthly charges',
    slCreditFormula: '7% of monthly charge per default beyond threshold',
    slCreditFrequency: 'Monthly',
    earnbackApplicable: 'Yes',
    earnbackClauseDescription: 'Earnback if 2 consecutive months meet target',
    earnbackMode: 'Credit reversal',
    earnbackFrequency: 'Monthly',
    serviceLevelDefault: 'Exceeded max resolution time',
    persistentDefaultClause: '2 months in a quarter triggers RCA',
    terminationTrigger: '4 defaults in 12 months',
    slStartDate: '2024-01-01',
    slEndDates: '2025-12-31',
    slEffectiveDate: '2024-02-01',
    reportingFrequency: 'Monthly',
  ...
  },
  {
    ...
    unitOfMeasurement: 'Hours',
    minOrMax: 'Maximum',
    expectedTargetValue: '48',
    thresholdValueFloor: '60',
    thresholdValueBasement: '72',
    measurementWindow: 'Per incident',
    computationFrequency: 'Monthly',
    exclusions: 'Customer-caused delays excluded',
    slCreditApplicable: 'Yes',
    slCreditClauseDescription: 'Credits after 3 defaults in a month',
    slCreditMode: 'Percent of monthly charges',
    slCreditFormula: '4% of monthly charge per default beyond threshold',
    slCreditFrequency: 'Monthly',
    earnbackApplicable: 'Yes',
    earnbackClauseDescription: 'Earnback if 3 consecutive months meet target',
    earnbackMode: 'Credit reversal',
    earnbackFrequency: 'Quarterly',
    serviceLevelDefault: 'Exceeded max resolution time',
    persistentDefaultClause: '3 months in a quarter triggers RCA',
    terminationTrigger: '5 defaults in 12 months',
    slStartDate: '2024-01-01',
    slEndDates: '2025-12-31',
    slEffectiveDate: '2024-02-01',
    reportingFrequency: 'Monthly',
